...
/** Select Props */
export interface SelectProps extends Omit<SelectHTMLAttributes<HTMLSelectElement>, 'size'>, PaddingMixin, MarginMixin {
     ...
     */
    size?: keyof typeof selectSizes | SelectHTMLAttributes<HTMLSelectElement>['size'];
    /**
